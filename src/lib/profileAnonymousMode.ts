export const PROFILE_ANON_MODE_OFF_CONFIRMATION =
  "Turning off anonymous mode will use your real name for new chats and upcoming bookings. Existing chats stay as they are until you change them in the chat. Continue?";
